...
<script>
    console.log('Toast test page loaded');
    console.log('Toast object available:', typeof Toast !== 'undefined');

    // Check if Toast is loaded after a delay
    setTimeout(() => {
        console.log('Toast object after delay:', typeof Toast !== 'undefined');
        console.log('Bootstrap available:', typeof bootstrap !== 'undefined');
        console.log('Bootstrap Toast available:', typeof bootstrap !== 'undefined' && bootstrap.Toast);

        if (typeof Toast === 'undefined') {
            console.error('Toast object not found!');
            console.log('Available global objects:', Object.keys(window).filter(key => key.includes('Toast') || key.includes('toast')));
        } else {
            console.log('Toast object found! Testing...');
